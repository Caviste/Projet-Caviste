...
function showDetails(index) {
    ...
    fetch(restCountriesURL + vin.country)
        .then(function(res) {
            ...
            $("#description").text("" + vin.description + ""); $("#couleur").val(vin.color); $("#capacite").val(vin.capacity + " CL");
            ...
            let request = new XMLHttpRequest(); request.open("GET", "http://cruth.phpnet.org/epfc/caviste/public/index.php/api/wines/" + index + "/comments", true);
